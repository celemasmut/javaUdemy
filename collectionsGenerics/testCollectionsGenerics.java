package udemy.collectionsGenerics;
...
public class testCollectionsGenerics {
    ...
    public static void main(String[] args) {
        List<String> myList = new ArrayList<>(); // guarda el orden por lo que las operaciones pueden ser lentas.
        ...
        Set<String> mySet = new HashSet<>(); // no garantiza orden. es mas rapido al agregar los elementos
        ...
        myMap.put("valor1","Alex");

        String elementoMap = myMap.get("valor2");
